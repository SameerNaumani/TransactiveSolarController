...
<head>
  ...
  <title>Solar Controller - Dashboard</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Solar Controller Admin <sup>2</sup></div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="img/darth-vader.png">
              </a>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Average Current (A)</div>
                      <div>
                        <table style="width:100%">
                          <thead>
                            <tr>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Average Voltage (V)</div>
                      <div>
                        <table style="width:100%">
                          <thead>
                            <tr>
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Power Overview</h6>
...
<script>
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyBOPGG0omMSv2kFcJGGKyrYUO3JrCC5An4",
    authDomain: "test-1-85a78.firebaseapp.com",
    databaseURL: "https://test-1-85a78.firebaseio.com",
    projectId: "test-1-85a78",
    storageBucket: "test-1-85a78.appspot.com",
    messagingSenderId: "313314885578",
    appId: "1:313314885578:web:d4d985ed48297e92f35933",
    measurementId: "G-FHWH159EB3"
  };
  // Initialize Firebase
